  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        ...
        {/* No button here - automatic process */}
      </Box>
      ...
      >
        <MenuItem onClick={() => {
          ...
          <ListItemText>Transfer to Hatcher</ListItemText>
        </MenuItem>
        {!selectedBatch?.notificationSent && (
          <MenuItem onClick={() => {
            if (selectedBatch) handleSendNotification(selectedBatch);
            handleMenuClose();
          }}>
            <ListItemIcon>
